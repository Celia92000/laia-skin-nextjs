      ...
      {sortedServices.map((service) => (
        ...
        >
          <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:-translate-y-2 h-full flex flex-col min-h-[400px]">
            {/* Image/Header */}
            <div className="h-48 bg-gradient-to-br from-primary/30 to-secondary/30 relative overflow-hidden flex-shrink-0">
              {service.featured && (
                <div className="absolute bottom-4 left-4 z-20 flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-primary to-secondary text-white rounded-full shadow-lg">
