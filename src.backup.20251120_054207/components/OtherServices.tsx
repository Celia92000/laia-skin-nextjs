      ...
      {services.map(service => (
        ...
        >
          ...
          <div className="p-6">
            ...
            <p className="text-accent/60 text-sm mb-4 line-clamp-2">
              ...
              <div className="text-right">
                {service.promoPrice ? (
                  <div className="flex items-center gap-2">
                    <span className="text-sm line-through text-accent/40">
                      {service.price}€
                    </span>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-100">
              <span className="text-primary font-medium text-sm group-hover:translate-x-2 transition-transform flex items-center gap-1">
                Découvrir
