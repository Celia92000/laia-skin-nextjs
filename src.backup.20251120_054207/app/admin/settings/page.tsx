...
import {
  ...
  Building, MapPin, Phone, Image as ImageIcon
} from 'lucide-react';
...
export default function AdminSettings() {
  ...
  const [activeTab, setActiveTab] = useState<'account' | 'site' | 'gallery' | 'subscription'>('account');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white p-6">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        ...
        <div className="flex gap-4 mt-6 border-b border-gray-200">
          ...
          {/* Galerie - Seulement pour ORG_OWNER, SUPER_ADMIN */}
          {hasFullAccess && (
            <button
