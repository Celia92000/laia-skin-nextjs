  ...
  try {
    ...
    for (const client of clients) {
      try {
        ...
        const fromEmail = client.organization?.OrganizationConfig?.contactEmail || process.env.EMAIL_FROM || 'noreply@laiaskin.com'
        const fromName = client.organization?.OrganizationConfig?.siteName || 'LAIA SKIN Institut'
