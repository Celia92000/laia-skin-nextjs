...
export async function PUT(request: Request) {
  ...
  try {
    ...
    if (type === 'social') {
      ...
      if (!existing || (existing.userId !== decoded.userId && existing.userId !== null && !['SUPER_ADMIN', 'ORG_ADMIN', 'LOCATION_MANAGER', 'STAFF', 'RECEPTIONIST', 'ACCOUNTANT', 'ADMIN', 'admin'].includes(decoded.role))) {
