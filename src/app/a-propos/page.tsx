    ...
    <main className="pt-36 pb-20 min-h-screen bg-gradient-to-br from-[#fdfbf7] to-[#f8f6f0]">
        ...
        <section className="max-w-6xl mx-auto px-4 mb-20">
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-6xl font-serif text-[#2c3e50] mb-6 animate-fade-in-up">
              Laïa, Experte Beauté
            </h1>
            <p className="text-xl text-[#2c3e50]/70 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in-up animation-delay-400">
              <h2 className="text-3xl font-serif text-[#2c3e50] mb-6">Mon Parcours</h2>
              ...
              <p className="text-[#2c3e50]/80 mb-6 font-semibold">
          ...
          <div className="mt-16 bg-white rounded-2xl p-8 shadow-xl relative">
            ...
            <p className="text-lg text-[#2c3e50]/80 italic text-center px-8">
        ...
        <section className="bg-white py-20">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-serif text-[#2c3e50] mb-6">Mes Valeurs</h2>
              ...
              <div className="bg-gradient-to-br from-[#fdfbf7] to-white rounded-2xl p-8 shadow-lg">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#2c3e50]/60">Cliente fidèle depuis 2 ans</p>
                  </div>
                </div>
              </div>
