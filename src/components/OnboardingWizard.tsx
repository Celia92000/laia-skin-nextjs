...
export default function OnboardingWizard({ onComplete }: { onComplete: () => void }) {
  ...
  const steps = [
    ...
    { number: 4, title: 'Configuration', icon: Settings, completed: false }
  ];
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {currentStep < 4 && (
            <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
              ...
              <button
                onClick={currentStep === 3 ? handleSaveAndContinue : handleNext}
              ...
              >
                {saving ? 'Enregistrement...' : currentStep === 3 ? 'Enregistrer et continuer' : 'Suivant'}
