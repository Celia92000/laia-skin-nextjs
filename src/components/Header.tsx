      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 sm:h-24">
          ...
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <h1 className="text-[9px] sm:text-[10px] md:text-[11px] lg:text-xs font-serif font-semibold tracking-tight whitespace-nowrap flex-shrink-0 inline-block" style={{ color: accentColor }}>
              {pathname === '/login' || pathname.startsWith('/status') || pathname.startsWith('/privacy') || pathname.startsWith('/cgv-laia-connect') || pathname.startsWith('/dpa') ? 'LAIA Connect' : (orgData?.config?.siteName || config.siteName)?.toUpperCase() || 'MON INSTITUT'}
            </h1>
          </Link>
