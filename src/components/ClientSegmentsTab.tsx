                        ...
                        onChange={(e) => setFormData({
                          ...
                          criteria: {
                            ...
                            totalSpent: {
                              ...
                              min: (e.target.value ? parseFloat(e.target.value) : undefined) as any
                            }
                          }
                        })}
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({
                          ...
                          criteria: {
                            ...
                            totalSpent: {
                              ...formData.criteria.totalSpent,
                              max: (e.target.value ? parseFloat(e.target.value) : undefined) as any
                            }
                          }
                        })}
                        className="border border-gray-300 rounded-lg px-4 py-2"
                          ...
                          criteria: {
                            ...
                            lastVisit: {
                              daysAgo: {
                                ...
                                min: (e.target.value ? parseInt(e.target.value) : undefined) as any
                              }
                            }
                          }
                        })}
                        ...
                        onChange={(e) => setFormData({
                          ...
                          criteria: {
                            ...
                            lastVisit: {
                              daysAgo: {
                                ...formData.criteria.lastVisit.daysAgo,
                                max: (e.target.value ? parseInt(e.target.value) : undefined) as any
                              }
                            }
                          }
                        })}
