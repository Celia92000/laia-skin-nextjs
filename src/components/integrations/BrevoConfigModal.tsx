...
export default function BrevoConfigModal({ onClose }: BrevoConfigModalProps) {
  return (
      ...
      <div className="bg-white rounded-xl max-w-md w-full p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold">Brevo</h3>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-blue-800 mt-2">
            Cette intégration sera disponible prochainement. Elle permettra d'automatiser vos campagnes email et SMS via Brevo (ex-Sendinblue).
          </p>
        </div>
