...
export default function ShopifyConfigModal({ onClose }: ShopifyConfigModalProps) {
  return (
      ...
      <div className="bg-white rounded-xl max-w-md w-full p-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-blue-800 mt-2">
            Cette intégration sera disponible prochainement. Elle permettra de synchroniser votre boutique en ligne Shopify avec LAIA.
          </p>
        </div>
