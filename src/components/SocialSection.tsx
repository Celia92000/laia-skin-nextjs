      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <span className="px-4 py-2 bg-[#d4b5a0]/10 text-[#d4b5a0] rounded-full text-sm font-semibold tracking-wide uppercase">
              Rejoignez notre communauté
            </span>
          </div>
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-[#2c3e50] mb-6 leading-tight">
            Suivez-nous et Restez Connecté
          </h2>
          <p className="text-lg md:text-xl text-[#2c3e50]/70 max-w-3xl mx-auto leading-relaxed">
            Scannez nos QR codes pour nous suivre sur les réseaux sociaux, découvrir nos offres exclusives
            et ne manquer aucune nouveauté
          </p>
        </div>

        {/* QR Codes avec fond blanc arrondi */}
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl p-8 md:p-12 mb-12">
